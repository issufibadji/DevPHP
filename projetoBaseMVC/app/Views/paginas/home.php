            ...
            <ul class="grid-list">
              ...
              <li data-filter="shaving">
                <div class="pricing-card">
                  ...
                  <figure class="card-banner img-holder" style="--width: 90; --height: 90;">
                    <img src="<?= URL . '/img/pricing-1.jpg'?>" width="90" height="90" alt="Hair Cutting & Fitting"
                      class="img-cover">
                  </figure>
              ...
              <li data-filter="shaving">
                <div class="pricing-card">
                  ...
                  <figure class="card-banner img-holder" style="--width: 90; --height: 90;">
                    <img src="<?= URL . '/img/pricing-2.jpg'?>" width="90" height="90" alt="Shaving & Facial"
                      class="img-cover">
                  </figure>
              ...
              <li data-filter="face-washing">
                <div class="pricing-card">
                  ...
                  <figure class="card-banner img-holder" style="--width: 90; --height: 90;">
                    <img  src="<?= URL . '/img/pricing-3.jpg'?>"  width="90" height="90" alt="Hair Color & Wash"
                      class="img-cover">
                  </figure>
              ...
              <li data-filter="body-treatments">
                <div class="pricing-card">
                  ...
                  <figure class="card-banner img-holder" style="--width: 90; --height: 90;">
                    <img src="<?= URL . '/img/pricing-4.jpg'?>" width="90" height="90" alt="Body Massage"
                      class="img-cover">
                  </figure>
              ...
              <li data-filter="face-washing">
                <div class="pricing-card">
                  ...
                  <figure class="card-banner img-holder" style="--width: 90; --height: 90;">
                    <img src="<?= URL . '/img/pricing-6.jpg'?>" width="90" height="90" alt="Facial & Face Wash"
                      class="img-cover">
                  </figure>
              ...
              <li data-filter="body-treatments">
                <div class="pricing-card">
                  ...
                  <figure class="card-banner img-holder" style="--width: 90; --height: 90;">
                    <img src="<?= URL . '/img/pricing-7.jpg'?>" width="90" height="90" alt="Backbone Massage"
                      class="img-cover">
                  </figure>
              ...
              <li data-filter="meditations">
                <div class="pricing-card">
                  ...
                  <figure class="card-banner img-holder" style="--width: 90; --height: 90;">
                    <img src="<?= URL . '/img/pricing-8.jpg'?>" width="90" height="90" alt="Meditation & Massage"
                      class="img-cover">
                  </figure>
          ...
          <ul class="grid-list">
            ...
            <li>
              <div class="gallery-card">
                ...
                <figure class="card-banner img-holder" style="--width: 422; --height: 550;">
                  <img src="<?= URL . '/img/gallery-1.jpg'?>"  width="422" height="550" loading="lazy" alt="Hair Cutting"
                    class="img-cover">
                </figure>
            ...
            <li>
              <div class="gallery-card">
                ...
                <figure class="card-banner img-holder" style="--width: 422; --height: 550;">
                  <img src="<?= URL . '/img/gallery-2.jpg'?>"  width="422" height="550" loading="lazy" alt="Hair Cutting"
                    class="img-cover">
                </figure>
            ...
            <li>
              <div class="gallery-card">
                ...
                <figure class="card-banner img-holder" style="--width: 422; --height: 550;">
                  <img src="<?= URL . '/img/gallery-3.jpg'?>"  width="422" height="550" loading="lazy" alt="Hair Cutting"
                    class="img-cover">
                </figure>
            ...
            <li>
              <div class="gallery-card">
                ...
                <figure class="card-banner img-holder" style="--width: 422; --height: 550;">
                  <img src="<?= URL . '/img/gallery-4.jpg'?>"  width="422" height="550" loading="lazy" alt="Hair Cutting"
                    class="img-cover">
                </figure>
        ...
        <div class="container">
          ...
          <div class="appoin-card">
            ...
            <figure class="card-banner img-holder" style="--width: 250; --height: 774;">
              <img  src="<?= URL . '/img/appoin-banner-1.jpg'?>"  width="250" height="774" loading="lazy" alt=""
                class="img-cover">
            </figure>
            ...
            <figure class="card-banner img-holder" style="--width: 250; --height: 774;">
              <img src="<?= URL . '/img/appoin-banner-2.jpg'?>" width="250" height="774" loading="lazy" alt=""
                class="img-cover">
            </figure>
